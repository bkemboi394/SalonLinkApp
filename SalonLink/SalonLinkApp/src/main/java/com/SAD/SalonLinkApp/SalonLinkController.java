...
public class SalonLinkController {
    ...
    public String register(@ModelAttribute("registrationRequest") RegistrationRequest request, Model model) {
        ...
        try {
            ...
            model.addAttribute("message", "You have been registered successfully, welcome to our app!");
    ...
    public String showMakeReservationForm(Model model) {
        ...
        return "makereservation"; // Assuming "makereservation.html" is your make reservation page
    }
